...
DATASET_NAME = "Qlib"
DUCKDB_PATH = DATA_RAW / "Qlib.duckdb"
SQLITE_PATH = DATA_RAW / "Qlib.sqlite"

CLOSED_EVENT_TYPE_ID = 121
...
# OCEL2 event tables present in this dataset's sqlite file (30 tables).
EVENT_SUBTABLES = [
    "event_assigned",
