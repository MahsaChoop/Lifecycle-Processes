"""Dataset config: Vibe-Trading."""
from functions.config import DATA_RAW, RESULTS_FIGURES, RESULTS_FIGURES_NO_TITLES, RESULTS_TABLES

DATASET_NAME = "Vibe-Trading"
DUCKDB_PATH = DATA_RAW / "Vibe-Trading.duckdb"
SQLITE_PATH = DATA_RAW / "Vibe-Trading.sqlite"

CLOSED_EVENT_TYPE_ID = 2076
...
# OCEL2 event tables present in this dataset's sqlite file (26 tables).
EVENT_SUBTABLES = [
